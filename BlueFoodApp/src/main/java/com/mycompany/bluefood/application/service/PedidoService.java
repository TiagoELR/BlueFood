...
import com.mycompany.bluefood.domain.pagamento.DadosCartao;
import com.mycompany.bluefood.domain.pagamento.Pagamento;
import com.mycompany.bluefood.domain.pagamento.PagamentoRepository;
import com.mycompany.bluefood.domain.pagamento.StatusPagamento;
import com.mycompany.bluefood.domain.pedido.Carrinho;
import com.mycompany.bluefood.domain.pedido.ItemPedido;
import com.mycompany.bluefood.domain.pedido.ItemPedidoPK;
import com.mycompany.bluefood.domain.pedido.ItemPedidoRepository;
import com.mycompany.bluefood.domain.pedido.Pedido;
import com.mycompany.bluefood.domain.pedido.Pedido.Status;
...
public class PedidoService {
    ...
    public Pedido criarAndPagar(Carrinho carrinho, String numCartao) throws PagamentoException{
        ...
        throw new PagamentoException("Erro no servidor de pagamentos");
        }
